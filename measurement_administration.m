function [meas] = measurement_administration(meas)
    ...
    d = dialog('Position',[300 300 300 300],'Name','Measurement administration');
    ...
    speed_popup = uicontrol('Parent',d,...
           ...
           'String',{'2 deg_sec';'3 deg_sec';'4 deg_sec'},...
    ...
    repetition_popup = uicontrol('Parent',d,...
           ...
           'String',{'00';'01';'02';'03';'04';'05';'06';'07';'08';'09';'10';'11';'12';'13';'14';'15'},...
